...
@interface MQBGPreferencesListController : PSListController<UIPopoverPresentationControllerDelegate> {
...
@interface MQBGAppearanceSettings: HBAppearanceSettings

@end

@interface UIApplication (MQBG)
